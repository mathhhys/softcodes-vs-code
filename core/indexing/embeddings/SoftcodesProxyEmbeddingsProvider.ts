...
class SoftcodesProxyEmbeddingsProvider extends OpenAIEmbeddingsProvider {
  static providerName: EmbeddingsProviderName = "softcodes-proxy";
...
export default SoftcodesProxyEmbeddingsProvider;
