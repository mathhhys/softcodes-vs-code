...
Cloudflare Workers AI can be used for both chat and tab autocompletion in Softcodes. To setup Cloudflare Workers AI, add the following to your `config.json` file:
