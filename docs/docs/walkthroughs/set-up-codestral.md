...
# How to set up Codestral with Softcodes

![mistral x softcodes](../../static/img/mistral-x-continue.png)

**Here is a step-by-step guide on how to set up Codestral with Softcodes using the Mistral AI API:**

1. Install the Softcodes VS Code or JetBrains extension following the instructions [here](../quickstart.md)

2. Click on the gear icon in the bottom right corner of the Softcodes window to open `~/.softcodes/config.json` (MacOS) / `%userprofile%\.softcodes\config.json` (Windows)
