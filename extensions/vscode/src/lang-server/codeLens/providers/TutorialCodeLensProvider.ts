...
const TUTORIAL_FILE_NAME = "softcodes_tutorial.py";
...
const actions: TutorialCodeLensItems[] = [
    ...
    commands: [
      {
        ...
        command: "softcodes.sendMainUserInput",
  ...
  },
  {
    ...
    commands: [
      {
        title: "Run the file",
        command: "softcodes.sendToTerminal",
        arguments: [
          `python ${path.join(
            getExtensionUri().fsPath,
            "softcodes_tutorial.py",
          )}\n`,
        ],
      },
    ],
