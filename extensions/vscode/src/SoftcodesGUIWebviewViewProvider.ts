...
export class SoftcodesGUIWebviewViewProvider
  implements vscode.WebviewViewProvider
{
  public static readonly viewType = "softcodes.softcodesGUIView";
  ...
  private setupDebugLogsListener() {
    vscode.workspace.onDidChangeConfiguration((event) => {
      if (event.affectsConfiguration('softcodes.enableDebugLogs')) {
        const settings = vscode.workspace.getConfiguration("softcodes");
  ...
  constructor(
    ...
    this.outputChannel = vscode.window.createOutputChannel("Softcodes");
