      ...
      <div className="p-6 flex flex-col gap-6">
        <div className="grid grid-cols-3 gap-4 items-center">
          <div className="col-span-2">
            ...
            <p>
              Documentation will be coming soon. Check back for detailed guides on
              how to configure and use Softcodes.
            </p>
          </div>
          <div className="col-span-1">
            <SecondaryButton className="w-full" disabled>Coming Soon</SecondaryButton>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 items-center">
          <div className="col-span-2">
            ...
            <p>Let us know on Slack and we'll do our best to resolve it.</p>
          </div>
          <a
            href="https://softcodesgroupe.slack.com/archives/C08SA08N7DJ"
            target="_blank"
