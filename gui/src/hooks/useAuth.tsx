        ...
        if (!getLocalStorage("shownProfilesIntroduction")) {
          ...
          dispatch(
            setDialogMessage(
              <ConfirmationDialog
                text={
                  "Welcome to Softcodes for teams! Using the toggle in the bottom right, you can switch between your local profile (defined by config.json) and team profiles (defined in the Softcodes for teams web app). Each profile defines a set of models, slash commands, context providers, and other settings to customize Softcodes."
                }
    ...
    dispatch(
      setDialogMessage(
        <ConfirmationDialog
          ...
          text={"Are you sure you want to log out of Softcodes?"}
          onConfirm={() => {
